...
std::vector<Data *> fragmentationPaquet (Data &d, int mtu)	{
    ...
    while ( tp < tp_initial)	{
        ...
        encapsule_segment ( nullptr, nullptr, ip_id, f, boost::dynamic_bitset<> ( 13, tp*8+offset), ttl, pi[pi.size()-1]);
...
*/	
    ...
    Data * d = new Data ( s_tmp, DATA_SEGMENT);
